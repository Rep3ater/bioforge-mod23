...
public class BioForgeModelRegistry {
    ...
    public static void register(String modelId) {
        ResourceLocation rl = ResourceLocation.parse(modelId.contains(":") ? modelId : BioForgeMod.MODID + ":" + modelId);
    ...
    public static void onRegisterLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(
                LAYER_LOCATIONS.getOrDefault("bioforge:prosthetic_arm_basic",
                        new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BioForgeMod.MODID, "prosthetic_arm_basic"), "main")),
                BioForgeModelRegistry::buildProstheticArmLayer);

        event.registerLayerDefinition(
                LAYER_LOCATIONS.getOrDefault("bioforge:prosthetic_leg_basic",
                        new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BioForgeMod.MODID, "prosthetic_leg_basic"), "main")),
                BioForgeModelRegistry::buildProstheticLegLayer);

        event.registerLayerDefinition(
                LAYER_LOCATIONS.getOrDefault("bioforge:cybernetic_arm_v1",
                        new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BioForgeMod.MODID, "cybernetic_arm_v1"), "main")),
                BioForgeModelRegistry::buildCyberneticArmLayer);

        event.registerLayerDefinition(
                LAYER_LOCATIONS.getOrDefault("bioforge:cybernetic_leg_v1",
                        new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(BioForgeMod.MODID, "cybernetic_leg_v1"), "main")),
